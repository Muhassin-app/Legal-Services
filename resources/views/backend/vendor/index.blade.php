@extends('layouts.vertical', ['demo' => 'creative', 'title' => __(getNomenclatureName('vendors', true))])
@section('css')
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                @php
                    $vendors = __(getNomenclatureName('vendors', true));
        ...
        @else
            ...
            <!-- <div class="col-sm-6 text-sm-right">
                ...
                <button hidden class="btn btn-info waves-effect waves-light text-sm-right openAddModal" userId="0"><i class="mdi mdi-plus-circle mr-1"></i> {{ __('Add') }}
                </button>
            </div> -->
            @endif
        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-3 mb-3 mb-md-0">
                            <div class="text-center">
                                ...
                                <p class="text-muted font-15 mb-0"> {{ __($OpenNom) }} {{ __(getNomenclatureName('vendors', true))}}</p>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-3 mb-md-0">
                            <div class="text-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header border-bottom">
                    <h4 class="modal-title">{{ __('Edit') }} {{ __(getNomenclatureName('vendors', false))}}</h4>
