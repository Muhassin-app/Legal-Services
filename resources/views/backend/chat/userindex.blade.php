@extends('layouts.vertical', ['demo' => 'creative', 'title' => getNomenclatureName('User Chat', true)])
@section('css')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __(getNomenclatureName('User/User', true)) }}</h4>
                </div>
            </div>
        </div>
    </div>
...
@section('script-bottom')
    ...
    <script>
        $(document).ready(async function() {
            ...
            if (window.location.pathname.split('/')[4] != undefined && window.location.pathname.split('/')[4] !=
                null) {
