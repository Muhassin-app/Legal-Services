        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 mb-lg-0 mb-3 text-center">
                    <h3 class="mb-2">{{ __('Legal Services Registration') }}</h3>
                        ...
                        <div class="{{ (@session('preferences')->concise_signup == 1)? 'mx-auto':'offset-xl-2 col-xl-8 text-left' }}">
                            <form name="register" id="register" enctype="multipart/form-data" action="{{ route('customer.register') }}"
                                ...
                                <div class="row form-group mb-0 ">
                                                        ...
                                                        <div class="file file--upload">
                                                            ...
                                                            @if (strtolower($vendor_registration_document->file_type) == 'image')
                                                                <input
                                                                    ...
                                                                    id="input_fiUpload Document:le_logo_{{ $vendor_registration_document->id }}"
                                                                    type="file"
                                                                    name="{{ $vendor_registration_document->primary->slug }}"
                                                                    accept="image/*"
                                    ...
                                    {{-- <div id="lawyer-document-section" style="display: none;">
                                        <div class="form-group mb-3">
                                            <label for="lawyer_certificate">{{ __('Upload Lawyer Certificate') }}</label>
                                            <input type="file" name="lawyer_certificate" id="lawyer_certificate" class="form-control">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="is_lawyer" name="is_lawyer">
                                        <label class="form-check-label" for="is_lawyer">{{ __('Register as a Lawyer') }}</label>
                                    </div>
                                    <div id="lawyer-document-section"  class="col-md-6 mb-3" style="display: none;">
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const lawyerCheckbox = document.getElementById('is_lawyer');
            const lawyerSection = document.getElementById('lawyer-document-section');

            lawyerCheckbox.addEventListener('change', function () {
                if (this.checked) {
