    ...
    <div class="container">
        <div class="row align-items-center h-100" id="login-section">
            ...
            <div class="col-lg-6 text-center">
                <h3 class="mb-md-3 mb-2">{{ __('New Lawyer') }}</h3>
...
<script>
    ...
    $("#username").on("countrychange", function(e) {
    var countryData = iti.getSelectedCountryData();
    
    console.log("Country Changed:", countryData);

    if (countryData) {
        $('#countryData').val(countryData.iso2);  // Set country code (e.g., "us", "in")
        $('#dialCode').val(countryData.dialCode); // Set dial code (e.g., "1", "91")
    }
});
